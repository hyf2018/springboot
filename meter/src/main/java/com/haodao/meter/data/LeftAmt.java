...
/**
 * <剩余金额> 比如：“33 33 33 33 77”； 原始数据为十六进制，4字节数据，1字节单位； 需要减33H； 解析使用BCD码(8421)算法；
 * 
 * @author hyf
 *
 */
public class LeftAmt {
	/**
	 * 原始数据字符串长度
	 */
	...
	public Object[] calculate() throws Exception {
		...
		System.out.println("剩余金额BCD码:" + dataStr);
	...
	public LeftAmt(String data) {
		super();
		this.data = data;
	}

	public LeftAmt(String data, String delimiter, boolean isSeqPositive) {
		super();
		this.data = data;
	...
	public static void main(String[] args) throws Exception {
		String data = "34 35 36 37 77";
		LeftAmt cn = new LeftAmt(data);
