...
/**
 * <当前底数> 比如：“34 33 33 33 58”； 原始数据为十六进制，4字节数据，1字节单位； 需要减33H； 解析使用BCD码(8421)算法；
 * 
 * @author hyf
 *
 */
...
//		System.out.println("当前底数BCD码:" + dataStr);
	...
	public CurrentNumber(String data) {
		super();
		this.data = data;
	}

	public CurrentNumber(String data, String delimiter, boolean isSeqPositive) {
		super();
		this.data = data;
	...
	public static void main(String[] args) throws Exception {
		String data = "33 33 33 33 58";
		CurrentNumber cn = new CurrentNumber(data);
